function [ind,pea,base,basepea,down,downpea,RiseTime,DownTime,hd,ha]=traceAnalysis(sss,r,Time)
...
%                             n=n+1;
%                         end
%                         RiseTime=Time(n1+n)-Time(n1);
%                         DownTime=Time(n2)n2-nn;
%                     else
%                         done=0;
%                         n=0;
%                         while(done==0)
...
%                     end
                    ...
                    if nn+n<r
                        hd=hd+n-1;
                        ha=sum(sss(nn-n1:nn+n-1).*Time(nn-n1:nn+n-1));
                    else
                        hd=NaN;
                        ha=NaN;                        
                    end
