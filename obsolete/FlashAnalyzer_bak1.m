...
%     Data_cursor=ind2rgb(Data_cursor,map);
    ...
    Mergebutton=uicontrol(panel1111,'style','togglebutton','CData',imread('.\bitmaps\merge.bmp'),'units','Normalized','position',[3/10,1/2,1/10,1/2],'TooltipString','Stop','callback',@adjustBC); 
...
%     Auto=uicontrol(panel1111,'style','pushbutton','TooltipString','Automatic detection','CData',Auto,'units','Normalized','position',[2/10,0,1/10,1/2],'visible','on','BusyAction','cancel');
    uicontrol(panel1111,'style','pushbutton','TooltipString','Automatic detection','CData',Auto,'units','Normalized','position',[2/10,0,1/10,1/2],'visible','on','callback',@autof,'BusyAction','cancel');
...
%  trace.f3是flash的trace
    ...
    slider=uicontrol(panel1121,'style','slider','String',num2str(i),'units','Normalized','position',[0,1/3,1,2/3],'enable','off');
...
%             axis(trace.f3,[1,r,min(signal)-10,max(signal)+10])
    ...
    function savestatusf(~,~)  
        ...
        newpathsavestatus='D:\Lsm_results\';
        if strcmp(Filename(end-3:end),'.lsm')||strcmp(Filename(end-3:end),'.mat')
            Filename=Filename(1:end-4);
        end
...
%                         basepea=zeros(1,length(line));
    ...
    function showImageWithFilename(s,e)
